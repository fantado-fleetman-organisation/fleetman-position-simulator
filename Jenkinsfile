pipeline {
   agent any
   parameters {
     string(name: 'SERVICE_NAME', defaultValue: 'fleetman-position-simulator', description: 'Microservice name')
     string(name: 'ECR_REPO_NAME', defaultValue: 'fleetman-position-simulator', description: 'ECR repo name')
